...
- [ ] All text is readable at the final 183.0 mm width; no labels collide or clip.
...
- [ ] Claim limits are retained in the text/caption: Post-hoc interpretability analysis; No causal claim from weight–accuracy association
